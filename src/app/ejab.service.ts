...
export class XMPPService {
    ...
    public dismiss: any;
    private BOSH_SERVICE: string = "http://ec2-44-195-129-233.compute-1.amazonaws.com:5280/bosh";
    private CONFERENCE_SERVICE: string = "conference.ec2-44-195-129-233.compute-1.amazonaws.com";
